...
Provision Baloo Bhaijaan 2 in the actual product; audit one real Intranet page; implement core components in the actual project stack; then test operational and engineering compositions. Freeze `v1.0.0` only after the three pilots and accessibility, responsive, and RTL checks have evidence.
