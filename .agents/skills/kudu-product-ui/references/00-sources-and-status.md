...
| Product typography | User clarification: Baloo Bhaijaan 2 for English and Arabic | Approved product typography; supersedes earlier font selections |
...
| Typography | 20-21 | The brand document contains separate typography guidance. The request owner approved Baloo Bhaijaan 2 for English and Arabic for this product skill. |
...
The file describes brand applications, not a component library. Warm off-white surfaces, outline primary buttons, modal behavior, and icon rules are product decisions, not direct PDF requirements. The typography specification is not proof that the logo lettering is a commercially available font. For this skill, the owner's Baloo Bhaijaan 2 clarification controls product UI typography.
